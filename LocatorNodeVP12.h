...
public:
	...
	MUserData* prepareForDraw(const MDagPath& objPath, const MDagPath& drawManager, const MHWRender::MFrameContext& frameContext, const MUserData* userData) override;
